  ...
  return (
    <header
      className={`fixed left-0 top-0 z-99999 w-full py-0 ${
        stickyMenu
          ? "bg-white !py-0 shadow transition duration-100 dark:bg-black"
          : ""
      }`}
    >
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          ...
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center lg:hidden md:hidden">
            <Image
              ...
              width="25"
              height="25"
              className="ml-16 bg-background dark:hidden"
            />
             <Image
              src="/whatsapp-logo.svg"
              alt="WhatsApp"
              width="25"
              height="25"
              className="mr-12 bg-background hidden dark:block"
            />
        ...
        >
          <nav>
            <ul className="flex flex-col gap-5 xl:flex-row xl:items-center xl:gap-10 ml-0 lg:ml-40">
