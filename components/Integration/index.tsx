      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `ABOUT US`,
              subtitle: `Expert Tax Solutions for Canadians`,
              description: `At File Clever, we simplify tax filing for Canadians. Our Toronto-based team of experts ensures maximum credits and deductions while maintaining compliance. Trust us for effortless, reliable tax solutions.`,
            }}
          />
