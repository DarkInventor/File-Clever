...
//                   Maximize Your Refund with Expert Remote Tax Services.
//                 </p>
...
//                 </p>
//                 <a
//                   href="mailto:tax@fileclever.com"
...
//               <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-3/3 xl:w-7/12">
//                 <motion.div
//                   variants={{
//                     hidden: {
//                       opacity: 0,
...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16 lg:px-0">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
          <div className="space-y-8 ">
            ...
            <p className="text-base text-gray-500 dark:text-gray-400 max-w-md">
              Maximize Your Refund with Expert Remote Tax Services. We provide comprehensive tax solutions tailored to
              your needs.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-2 lg:grid-cols-3 ml-0 lg:ml-20">
            <div>
              <h3 className="text-base font-medium text-gray-900 dark:text-white mb-4">Quick Links</h3>
            ...
            <div>
              <h3 className="text-base font-medium text-gray-900 dark:text-white mb-4">Contact Us</h3>
              <ul className="space-y-4">
                <li>
                  <a
                    href="mailto:tax@fileclever.com"
            ...
            <div className="ml-0 lg:ml-10">
              <h3 className="text-base font-medium text-gray-900 dark:text-white mb-4 ">Office Hours</h3>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-700">
          <p className="text-base text-gray-400 text-center">&copy; {currentYear} FileClever. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
